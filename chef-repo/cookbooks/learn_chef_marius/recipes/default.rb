...
if platform?('linuxmint') && node['platform_version'] >= '17.3'
   package ['openssh-server', 'pidgin', 'finch', 'chromium-browser', 'xwrits', 'rhythmbox', 'eclipse', 'mint-meta-mate', 'mrxvt', 'gedit', 'xsane', 'mplayer', 'busybox', 'sudo', 'screen', 'vim', 'cdrdao', 'skype', 'gimp', 'graphicsmagick', 'sysstat', 'encfs', 'iotop', 'latencytop', 'eclipse', 'eclipse-rse', 'eog', 'ncftp', 'libreoffice-calc', 'libreoffice-writer', 'libreoffice-impress', 'netpbm', 'sox', 'lame', 'rcs', 'wine', 'lsscsi', 'unrar', 'cabextract', 'gstreamer*-plugins*', 'gnucash', 'cups', 'lshw', 'pptp-linux', 'id3', 'gnokii', 'xgnokii', 'mtr', 'htmldoc', 'cups-pdf', 'tftpd', 'nmap', 'proftpd', 'vlc', 'pidgin-plugin-pack', 'pidgin-skype', 'xfce4', 'mate-desktop', 'unixODBC', 'libmyodbc', 'lynx', 'gpm', 'mplayer-gui', 'gcc', 'strace', 'ltrace', 'eclipse-cdt', 'smartmontools', 'libasound2', 'libexpat1', 'libfontconfig1', 'libglapi-mesa', 'libpulse0', 'vlc-plugin-sdl', 'libsmpeg0', 'nfs-common', 'traceroute', 'tcl-tls', 'tk8.5', 'whois', 'vym', 'mtpfs', 'evince', 'workrave', 'thunderbird', 'apt-file', 'vim-gnome', 'git', 'xclip', 'xvfb', 'mate-screensaver', 'keepass2', 'keepassx', 'ia32-libs', 'ia32-libs-gtk','vncviewer']
elsif platform?('linuxmint') && node['platform_version'] >= '17.2'
   package ['openssh-server', 'pidgin', 'finch', 'chromium-browser', 'xwrits', 'rhythmbox', 'eclipse', 'mint-meta-mate', 'mrxvt', 'gedit', 'xsane', 'mplayer', 'busybox', 'sudo', 'screen', 'vim', 'cdrdao', 'skype', 'gimp', 'graphicsmagick', 'sysstat', 'encfs', 'iotop', 'latencytop', 'eclipse', 'eclipse-rse', 'eog', 'ncftp', 'libreoffice-calc', 'libreoffice-writer', 'libreoffice-impress', 'netpbm', 'sox', 'lame', 'rcs', 'wine', 'lsscsi', 'unrar', 'cabextract', 'gstreamer*-plugins*', 'gnucash', 'cups', 'lshw', 'pptp-linux', 'id3', 'gnokii', 'xgnokii', 'mtr', 'htmldoc', 'cups-pdf', 'tftpd', 'nmap', 'proftpd', 'vlc', 'pidgin-plugin-pack', 'pidgin-skype', 'xfce4', 'mate-desktop', 'unixODBC', 'libmyodbc', 'lynx', 'gpm', 'mplayer-gui', 'gcc', 'strace', 'ltrace', 'eclipse-cdt', 'smartmontools', 'libasound2', 'libexpat1', 'libfontconfig1', 'libgl1-mesa-glx', 'libglapi-mesa', 'libpulse0', 'vlc-plugin-sdl', 'libsmpeg0', 'nfs-common', 'traceroute', 'tcl-tls', 'tk8.5', 'whois', 'vym', 'mtpfs', 'evince', 'workrave', 'thunderbird', 'apt-file', 'vim-gnome', 'git', 'xclip', 'xvfb', 'mate-screensaver', 'keepass2', 'keepassx', 'ia32-libs', 'ia32-libs-gtk','vncviewer']
elsif platform?('linuxmint') && node['platform_version'] >= '17.1'
